...
[![Travis build status](https://travis-ci.com/treynolds-conestoga/Automated.Tasks.svg?branch=master)](https://travis-ci.com/treynolds-conestoga/Automated.Tasks)
<!-- badges: end -->
...
You can install the development version of Automated.Tasks from [GitHub](https://github.com/) with:
